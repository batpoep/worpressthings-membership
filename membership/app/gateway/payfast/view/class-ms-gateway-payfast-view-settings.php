...
class MS_Gateway_PayFast_View_Settings extends MS_View {
	...
	public function to_html() {
		...
		<form class="ms-gateway-settings-form ms-form">
			...
			$description = sprintf(
				...
				__( 'This the a basic PayFast gateway that allows your members to easily make a single payment.', 'membership2' )
			);
	...
	protected function prepare_fields() {
		...
		$fields = array(
			...
			'merchant_id' 	=> array(
				...
				'title' 		=> __( 'Merchant ID', 'membership2' ),
			...
			'merchant_key' 	=> array(
				...
				'title' 		=> __( 'Merchant Key', 'membership2' ),

				'value' 		=> $gateway->merchant_key,
			...
			'passphrase' 	=> array(
				...
				'title' 		=> __( 'Passphrase', 'membership2' ),
			...
			'mode' 			=> array(
				...
				'title' 		=> __( 'PayFast Mode', 'membership2' ),
